...
class HomePageViewController: UIViewController {
    ...
    func collectionViewConfigure(){
        ...
        let cellWidth = 160
        design.sectionInset = UIEdgeInsets(top: 10, left: 16, bottom: 10, right: 16)
        design.itemSize = CGSize(width: cellWidth, height: 240)
...
extension HomePageViewController : UICollectionViewDelegate , UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.characterRaceLabel.text = characterViewModel.species
        cell.characterGenderLabel.text = characterViewModel.status
